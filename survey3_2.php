    ...
    <div class="container-fluid">
        ...
        <form role="form" action="" method="post">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="checkbox"><label><input type="checkbox" name="3_3_1_b" id="3_3_1_b" value="2">වැසි
                                ජලය </label>
                        </div>
                        <div class="checkbox"><label><input type="checkbox" name="3_3_1_c" id="3_3_1_c" value="3"> සුළු
                                වාරිමාර්ග වලින් ජලය</label> </div>
                        <div class="checkbox"><label><input type="checkbox" name="3_3_1_d" id="3_3_1_d" value="4">
                                ගැඹුරු ළිං</label></div>
                        <div class="checkbox"> <label><input type="checkbox" name="3_3_1_e" id="3_3_1_e" value="5"> කෘෂි
                                ළිං</label> </div>
                        <div class="checkbox"> <label><input type="checkbox" name="3_3_1_f" id="3_3_1_f" value="6"
                                    onclick="eDcheckOT('3_3_1_f','3_3_1_f_oth')"> වෙනත්</label> </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">3.3.2. වාරිමාර්ග සඳහා දරන ලද වියදම් </label>
                        <table class="table table-bordered table-hover">
<tr>
    <th> හේතුව</th>
    <th>පිරිවැය</th>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-hover">
                        <tr>
                            <th></th>
                            <th rowspan="1"> පුහුණු කිරීමේ ක්‍රමය</th>
                        ...
                        <div class="form-check">
                          ...
                          <label class="form-check-label">ඉඩම් කළමනාකරණය</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="3_4_1b" id="3_4_1b" value="2" checked="">
                          <label class="form-check-label">අස්වනු නෙලීම</label>
                        </div> 
                      </div>
                            </td>
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" name="3_5_3" id="3_5_3">
                            ...
                            <option value="2">තෘප්තිමත්, වෙනත් කන්න වල අස්වැන්න සමග සසදන විට අඩු අස්වනු වෙනසක් සහිතව
                                අස්වැන්න ලැබී තිබුණා</option>
                            <option value="3">සෑහීමකට පත්වෙන්නෙත් නැහැ, අතෘප්තිමත් වෙන්නෙත් නැහැ, අස්වැන්නෙහි කිසිදු
                                වෙනසක් නොමැත</option>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div><input type="text" name="3_6_1" id="3_6_1" placeholder="වෙලඳපොල" class="form-control" />
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="checkbox"><label><input type="checkbox" name="3_6_3c" id="3_6_3c" value="3">වෙළෙන්දා
                                වී මිලදී ගැනීමට දොරකඩට පැමිණේ
                            </label> </div>

                        <div class="checkbox"> <label><input type="checkbox" name="3_6_3d" id="3_6_3d" value="4"
                                    onclick="eDcheckOT('3_6_3d','3_6_3d_oth')">වෙනත්</label> </div>
