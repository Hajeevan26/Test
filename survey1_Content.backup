        ...
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td> 1.1.3.1 <div class="input-group">
                        <select class="form-control" name="1_1_3_1" id="1_1_3_1">
                ...
                <td> 1.1.6.1 <div class="input-group">
                        <select class="form-control " name="1_1_6_1" id="1_1_6_1">
                ...
                <td> 1.1.7.1 <div class="input-group">
                        <select class="form-control" name="1_1_7_1" id="1_1_7_1">
                ...
                <td> 1.1.10.1 <div class="input-group">
                        <select class="form-control" name="1_1_10_1" id="1_1_10_1">
                ...
                <td> 1.1.11.1 <div class="input-group">
                        <select class="form-control" name="1_1_11_1" id="1_1_11_1">
            ...
            <tr>
                ...
                <td> 1.1.3.2 <div class="input-group">
                        <select class="form-control" name="1_1_3_2" id="1_1_3_2">
                            <option value="1">Head of the household </option>
                            <option value="2">Wife / Husband </option>
                            <option value="3">Son / Daughter </option>
                            <option value="4">Parents</option>
                ...
                <td> 1.1.6.2 <div class="input-group">
                        <select class="form-control" name="1_1_6_2" id="1_1_6_2">
                            <option value="1">Sinhala</option>
                            <option value="2">Sri Lanka Tami</option>
                            <option value="3">India Tamil </option>
                            <option value="4">Sri Lanka Moor</option>
                ...
                <td> 1.1.7.2 <div class="input-group">
                        <select class="form-control" name="1_1_7_2" id="1_1_7_2">
                            <option value="1">Buddhist</option>
                            <option value="2">Hindu</option>
                            <option value="3">Islam</option>
                            <option value="4">Roman Catholic / Other Christian</option>
                ...
                <td> 1.1.10.2 <div class="input-group">
                        <select class="form-control" name="1_1_10_2" id="1_1_10_2">
                            <option value="1">Employed</option>
                            <option value="2">Looking for a job</option>
                            <option value="3">Student</option>
                            <option value="4">Household work</option>
                ...
                <td> 1.1.11.2 <div class="input-group">
                        <select class="form-control" name="1_1_11_2" id="1_1_11_2">
                            <option value="1">Government Employee</option>
                            <option value="2">Semi-government Employee </option>
                            <option value="3">Private sector employee</option>
                            <option value="4">Employer</option>
            ...
            <tr>
                ...
                <td> 1.1.3.3 <div class="input-group">
                        <select class="form-control" name="1_1_3_3" id="1_1_3_3">
                            <option value="1">Head of the household </option>
                            <option value="2">Wife / Husband </option>
                            <option value="3">Son / Daughter </option>
                            <option value="4">Parents</option>
                ...
                <td> 1.1.6.3 <div class="input-group">
                        <select class="form-control" name="1_1_6_3" id="1_1_6_3">
                            <option value="1">Sinhala</option>
                            <option value="2">Sri Lanka Tami</option>
                            <option value="3">India Tamil </option>
                            <option value="4">Sri Lanka Moor</option>
                ...
                <td> 1.1.7.3 <div class="input-group">
                        <select class="form-control" name="1_1_7_3" id="1_1_7_3">
                            <option value="1">Buddhist</option>
                            <option value="2">Hindu</option>
                            <option value="3">Islam</option>
                            <option value="4">Roman Catholic / Other Christian</option>
                ...
                <td> 1.1.10.3 <div class="input-group">
                        <select class="form-control" name="1_1_10_3" id="1_1_10_3">
                            <option value="1">Employed</option>
                            <option value="2">Looking for a job</option>
                            <option value="3">Student</option>
                            <option value="4">Household work</option>
                ...
                <td> 1.1.11.3 <div class="input-group">
                        <select class="form-control" name="1_1_11_3" id="1_1_11_3">
                            <option value="1">Government Employee</option>
                            <option value="2">Semi-government Employee </option>
                            <option value="3">Private sector employee</option>
                            <option value="4">Employer</option>
            ...
            <tr>
                ...
                <td> 1.1.3.4 <div class="input-group">
                        <select class="form-control" name="1_1_3_4" id="1_1_3_4">
                            <option value="1">Head of the household </option>
                            <option value="2">Wife / Husband </option>
                            <option value="3">Son / Daughter </option>
                            <option value="4">Parents</option>
                ...
                <td> 1.1.6.4 <div class="input-group">
                        <select class="form-control" name="1_1_6_4" id="1_1_6_4">
                            <option value="1">Sinhala</option>
                            <option value="2">Sri Lanka Tami</option>
                            <option value="3">India Tamil </option>
                            <option value="4">Sri Lanka Moor</option>
                ...
                <td> 1.1.7.4 <div class="input-group">
                        <select class="form-control" name="1_1_7_4" id="1_1_7_4">
                            <option value="1">Buddhist</option>
                            <option value="2">Hindu</option>
                            <option value="3">Islam</option>
                            <option value="4">Roman Catholic / Other Christian</option>
                ...
                <td> 1.1.10.4 <div class="input-group">
                        <select class="form-control" name="1_1_10_4" id="1_1_10_4">
                            <option value="1">Employed</option>
                            <option value="2">Looking for a job</option>
                            <option value="3">Student</option>
                            <option value="4">Household work</option>
                ...
                <td> 1.1.11.4 <div class="input-group">
                        <select class="form-control" name="1_1_11_4" id="1_1_11_4">
                            <option value="1">Government Employee</option>
                            <option value="2">Semi-government Employee </option>
                            <option value="3">Private sector employee</option>
                            <option value="4">Employer</option>
            ...
            <tr>
                ...
                <td> 1.1.3.5 <div class="input-group">
                        <select class="form-control" name="1_1_3_5" id="1_1_3_5">
                            <option value="1">Head of the household </option>
                            <option value="2">Wife / Husband </option>
                            <option value="3">Son / Daughter </option>
                            <option value="4">Parents</option>
                ...
                <td> 1.1.6.5 <div class="input-group">
                        <select class="form-control" name="1_1_6_5" id="1_1_6_5">
                            <option value="1">Sinhala</option>
                            <option value="2">Sri Lanka Tami</option>
                            <option value="3">India Tamil </option>
                            <option value="4">Sri Lanka Moor</option>
                ...
                <td> 1.1.7.5 <div class="input-group">
                        <select class="form-control" name="1_1_7_5" id="1_1_7_5">
                            <option value="1">Buddhist</option>
                            <option value="2">Hindu</option>
                            <option value="3">Islam</option>
                            <option value="4">Roman Catholic / Other Christian</option>
                ...
                <td> 1.1.10.5 <div class="input-group">
                        <select class="form-control" name="1_1_10_5" id="1_1_10_5">
                            <option value="1">Employed</option>
                            <option value="2">Looking for a job</option>
                            <option value="3">Student</option>
                            <option value="4">Household work</option>
                ...
                <td> 1.1.11.5 <div class="input-group">
                        <select class="form-control" name="1_1_11_5" id="1_1_11_5">
                            <option value="1">Government Employee</option>
                            <option value="2">Semi-government Employee </option>
                            <option value="3">Private sector employee</option>
                            <option value="4">Employer</option>
            ...
            <tr>
                ...
                <td> 1.1.3.6 <div class="input-group">
                        <select class="form-control" name="1_1_3_6" id="1_1_3_6">
                            <option value="1">Head of the household </option>
                            <option value="2">Wife / Husband </option>
                            <option value="3">Son / Daughter </option>
                            <option value="4">Parents</option>
                ...
                <td> 1.1.6.6 <div class="input-group">
                        <select class="form-control" name="1_1_6_6" id="1_1_6_6">
                            <option value="1">Sinhala</option>
                            <option value="2">Sri Lanka Tami</option>
                            <option value="3">India Tamil </option>
                            <option value="4">Sri Lanka Moor</option>
                ...
                <td> 1.1.7.6 <div class="input-group">
                        <select class="form-control" name="1_1_7_6" id="1_1_7_6">
                            <option value="1">Buddhist</option>
                            <option value="2">Hindu</option>
                            <option value="3">Islam</option>
                            <option value="4">Roman Catholic / Other Christian</option>
                ...
                <td> 1.1.10.6 <div class="input-group">
                        <select class="form-control" name="1_1_10_6" id="1_1_10_6">
                            <option value="1">Employed</option>
                            <option value="2">Looking for a job</option>
                            <option value="3">Student</option>
                            <option value="4">Household work</option>
                ...
                <td> 1.1.11.6 <div class="input-group">
                        <select class="form-control" name="1_1_11_6" id="1_1_11_6">
                            <option value="1">Government Employee</option>
                            <option value="2">Semi-government Employee </option>
                            <option value="3">Private sector employee</option>
                            <option value="4">Employer</option>
            ...
            <tr>
                ...
                <td> 1.1.3.7 <div class="input-group">
                        <select class="form-control" name="1_1_3_7" id="1_1_3_7">
                            <option value="1">Head of the household </option>
                            <option value="2">Wife / Husband </option>
                            <option value="3">Son / Daughter </option>
                            <option value="4">Parents</option>
                ...
                <td> 1.1.6.7 <div class="input-group">
                        <select class="form-control" name="1_1_6_7" id="1_1_6_7">
                            <option value="1">Sinhala</option>
                            <option value="2">Sri Lanka Tami</option>
                            <option value="3">India Tamil </option>
                            <option value="4">Sri Lanka Moor</option>
                ...
                <td> 1.1.7.7 <div class="input-group">
                        <select class="form-control" name="1_1_7_7" id="1_1_7_7">
                            <option value="1">Buddhist</option>
                            <option value="2">Hindu</option>
                            <option value="3">Islam</option>
                            <option value="4">Roman Catholic / Other Christian</option>
                ...
                <td> 1.1.10.7 <div class="input-group">
                        <select class="form-control" name="1_1_10_7" id="1_1_10_7">
                            <option value="1">Employed</option>
                            <option value="2">Looking for a job</option>
                            <option value="3">Student</option>
                            <option value="4">Household work</option>
                ...
                <td> 1.1.11.7 <div class="input-group">
                        <select class="form-control" name="1_1_11_7" id="1_1_11_7">
                            <option value="1">Government Employee</option>
                            <option value="2">Semi-government Employee </option>
                            <option value="3">Private sector employee</option>
                            <option value="4">Employer</option>
            ...
            <tr>
                ...
                <td> 1.1.3.8 <div class="input-group">
                        <select class="form-control" name="1_1_3_8" id="1_1_3_8">
                            <option value="1">Head of the household </option>
                            <option value="2">Wife / Husband </option>
                            <option value="3">Son / Daughter </option>
                            <option value="4">Parents</option>
                ...
                <td> 1.1.6.8 <div class="input-group">
                        <select class="form-control" name="1_1_6_8" id="1_1_6_8">
                            <option value="1">Sinhala</option>
                            <option value="2">Sri Lanka Tami</option>
                            <option value="3">India Tamil </option>
                            <option value="4">Sri Lanka Moor</option>
                ...
                <td> 1.1.7.8 <div class="input-group">
                        <select class="form-control" name="1_1_7_8" id="1_1_7_8">
                            <option value="1">Buddhist</option>
                            <option value="2">Hindu</option>
                            <option value="3">Islam</option>
                            <option value="4">Roman Catholic / Other Christian</option>
                ...
                <td> 1.1.10.8 <div class="input-group">
                        <select class="form-control" name="1_1_10_8" id="1_1_10_8">
                            <option value="1">Employed</option>
                            <option value="2">Looking for a job</option>
                            <option value="3">Student</option>
                            <option value="4">Household work</option>
                ...
                <td> 1.1.11.8 <div class="input-group">
                        <select class="form-control" name="1_1_11_8" id="1_1_11_8">
                            <option value="1">Government Employee</option>
                            <option value="2">Semi-government Employee </option>
                            <option value="3">Private sector employee</option>
                            <option value="4">Employer</option>
            ...
            <tr>
                ...
                <td> 1.1.3.9 <div class="input-group">
                        <select class="form-control" name="1_1_3_9" id="1_1_3_9">
                            <option value="1">Head of the household </option>
                            <option value="2">Wife / Husband </option>
                            <option value="3">Son / Daughter </option>
                            <option value="4">Parents</option>
                ...
                <td> 1.1.6.9 <div class="input-group">
                        <select class="form-control" name="1_1_6_9" id="1_1_6_9">
                            <option value="1">Sinhala</option>
                            <option value="2">Sri Lanka Tami</option>
                            <option value="3">India Tamil </option>
                            <option value="4">Sri Lanka Moor</option>
                ...
                <td> 1.1.7.9 <div class="input-group">
                        <select class="form-control" name="1_1_7_9" id="1_1_7_9">
                            <option value="1">Buddhist</option>
                            <option value="2">Hindu</option>
                            <option value="3">Islam</option>
                            <option value="4">Roman Catholic / Other Christian</option>
                ...
                <td> 1.1.10.9 <div class="input-group">
                        <select class="form-control" name="1_1_10_9" id="1_1_10_9">
                            <option value="1">Employed</option>
                            <option value="2">Looking for a job</option>
                            <option value="3">Student</option>
                            <option value="4">Household work</option>
                ...
                <td> 1.1.11.9 <div class="input-group">
                        <select class="form-control" name="1_1_11_9" id="1_1_11_9">
                            <option value="1">Government Employee</option>
                            <option value="2">Semi-government Employee </option>
                            <option value="3">Private sector employee</option>
                            <option value="4">Employer</option>
            ...
            <tr>
                ...
                <td> 1.1.3.10 <div class="input-group">
                        <select class="form-control" name="1_1_3_10" id="1_1_3_10">
                            <option value="1">Head of the household </option>
                            <option value="2">Wife / Husband </option>
                            <option value="3">Son / Daughter </option>
                            <option value="4">Parents</option>
                ...
                <td> 1.1.7.10 <div class="input-group">
                        <select class="form-control" name="1_1_7_10" id="1_1_7_10">
                            <option value="1">Buddhist</option>
                            <option value="2">Hindu</option>
                            <option value="3">Islam</option>
                            <option value="4">Roman Catholic / Other Christian</option>
                ...
                <td> 1.1.10.10 <div class="input-group">
                        <select class="form-control" name="1_1_10_10" id="1_1_10_10">
                            <option value="1">Employed</option>
                            <option value="2">Looking for a job</option>
                            <option value="3">Student</option>
                            <option value="4">Household work</option>
                ...
                <td> 1.1.11.10 <div class="input-group">
                        <select class="form-control" name="1_1_11_10" id="1_1_11_10">
                            <option value="1">Government Employee</option>
                            <option value="2">Semi-government Employee </option>
                            <option value="3">Private sector employee</option>
                            <option value="4">Employer</option>
