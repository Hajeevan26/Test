        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-hover">
                        <tr>
                            <th colspan="4">Paddy Sales of the last season (Maha 2021/22)</th>
                        </tr>
                        <tr>
                            <th>3.6.5. Name of the buyer</th>
                            <th>3.6.6. Quantity sold (Kg)
                            </th>
                            <th>3.6.7. Price/Kg </th>
                            <th>3.6.8. Revenue from paddy</th>
                        </tr>
                        <tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-hover">
                        <tr>
                            <th colspan="4">Paddy Sales of the last season (Maha 2020/21)</th>
                        </tr>
                        <tr>
                            <th>3.6.9. Name of the buyer</th>
                            <th>3.6.10. Quantity sold (Kg)
                            </th>
                            <th>3.6.11. Price/Kg </th>
                            <th>3.6.12. Revenue from paddy</th>
                        </tr>
                        <tr>
